...
public class LocationAlertPanel extends AlertContentPanel<LocationAlert> {
    private final Client client;

    public LocationAlertPanel(LocationAlert alert, Client client, Runnable onChange) {
    ...
    public void buildTypeContent() {
        ...
        JPanel xPos = PanelUtils.createLabeledComponent(
            ...
            PanelUtils.createSpinner(this.alert.getWorldPoint().getX(), Integer.MIN_VALUE, Integer.MAX_VALUE, 1,
        ...
        JPanel yPos = PanelUtils.createLabeledComponent(
            ...
            PanelUtils.createSpinner(this.alert.getWorldPoint().getY(), Integer.MIN_VALUE, Integer.MAX_VALUE, 1,
        ...
        JPanel plane = PanelUtils.createLabeledComponent(
            ...
            PanelUtils.createSpinner(this.alert.getWorldPoint().getPlane(), Integer.MIN_VALUE, Integer.MAX_VALUE, 1,
        ...
        this.addSubPanelControl(pointPanel)
