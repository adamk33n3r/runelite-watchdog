...
public class SpawnedAlertPanel extends AlertContentPanel<SpawnedAlert> {

    public SpawnedAlertPanel(SpawnedAlert alert, Runnable onChange) {
    ...
    public void buildTypeContent() {
        this.addSelect("Spawned/Despawned", "Spawned or Despawned", SpawnedAlert.SpawnedDespawned.class, this.alert.getSpawnedDespawned(), this.alert::setSpawnedDespawned)
            ...
            .addIf(b ->
                b.addSelect("Ownership", "Filter items by ownership", OwnershipFilterMode.class, this.alert.getItemOwnershipFilterMode(), this.alert::setItemOwnershipFilterMode),
